...
const DashboardBox = ({ employees, bills, income, products }) => {
  return (
    <div className="mt-5 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-7">
      <div className="rounded-md p-5 bg-gradient-to-r from-cyan-100 to-cyan-200 flex justify-between shadow-lg shadow-gray-200 transition-all duration-500 hover:scale-105 hover:shadow-gray-400 cursor-pointer">
        <div>
      ...
      <div className="rounded-md p-5 bg-gradient-to-r from-green-200 to-emerald-300 flex justify-between shadow-lg shadow-gray-200 transition-all duration-500 hover:scale-105 hover:shadow-gray-400 cursor-pointer">
        <div>
      ...
      <div className="rounded-md p-5 bg-gradient-to-r from-purple-200 to-purple-300 flex justify-between shadow-lg shadow-gray-200 transition-all duration-500 hover:scale-105 hover:shadow-gray-400 cursor-pointer">
        <div>
