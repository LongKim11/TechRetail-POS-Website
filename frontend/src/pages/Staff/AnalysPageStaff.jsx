      ...
      <div className="flex-1 p-7 bg-slate-100 overflow-hidden">
        {loading ? (
          ...
          <>
            ...
            <div className="flex flex-col xl:flex-row mt-7 mb-11 items-center gap-x-20 gap-y-5">
              ...
              <div className="xl:w-2/3 w-full">
                <div className="flex flex-col sm:flex-row gap-7 justify-end">
                  <div className="rounded-md p-5 flex shadow-lg shadow-gray-200 transition-all duration-500 hover:scale-105 hover:shadow-gray-400 cursor-pointer bg-white w-full sm:w-1/3">
