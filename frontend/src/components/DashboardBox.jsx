...
const DashboardBox = ({ employees, bills, income, products }) => {
  return (
    <div className="mt-5 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-7">
      <div className="rounded-md p-5 bg-gradient-to-r from-cyan-200 to-cyan-300 flex shadow-lg shadow-gray-200 transition-all duration-700 hover:scale-105 hover:shadow-gray-400 cursor-pointer">
        <div className="w-2/3">
      ...
      <div className="rounded-md p-5 bg-gradient-to-r from-yellow-200 to-yellow-300 flex shadow-lg shadow-gray-200 transition-all duration-700 hover:scale-105 hover:shadow-gray-400 cursor-pointer">
        <div className="w-2/3">
