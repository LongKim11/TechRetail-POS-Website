      ...
      <div className="flex-1 p-7 bg-slate-100 overflow-hidden">
        {loading ? (
          ...
          <>
            ...
            <div className="flex xl:flex-row flex-col gap-5 mt-11">
              <div className="w-full xl:w-1/2 bg-white rounded-lg shadow-md overflow-x-auto">
                ...
                <div className="min-w-full">
                  <table className="w-full table-auto">
                    <thead className="">
                      <tr>
                        <th className="p-4 bg-gray-100 whitespace-nowrap">
            ...
            <div className="flex justify-end">
              <div className="flex mt-11 fixed bottom-3">
                <Button
                  variant="outlined"
